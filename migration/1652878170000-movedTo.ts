...
export class movedTo1652878170000 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
			...
			await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_81126443ddd4dc1291f2e764da7" FOREIGN KEY ("movedToId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
	}
