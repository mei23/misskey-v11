			...
			os.store.state.device.inDeckMode
				? { path: '/', name: 'index', component: MkDeck, children: [
					{ path: '/@:user', component: () => import('../common/views/deck/deck.user-column.vue').then(m => m.default), children: [
						...
						{ path: 'only-following', component: () => import('../common/views/pages/only-following.vue').then(m => m.default) },
						{ path: 'only-followers', component: () => import('../common/views/pages/only-followers.vue').then(m => m.default) },
					]},
