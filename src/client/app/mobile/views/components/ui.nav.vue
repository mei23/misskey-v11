...
export default Vue.extend({
	...
	data() {
		return {
			...
			faNewspaper, faHashtag, faMoon, faSun, faHome, faColumns, faSync, faDesktop, faMobileAlt
		};
	},
