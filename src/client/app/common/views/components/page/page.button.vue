<template>
<div>
	<ui-button class="kudkigyw" @click="click()" :primary="value.primary"><mfm :text="script.interpolate(value.text)" :key="Math.random()" :plain="true" :nowrap="true" :is-note="false" :i="$store.state.i" /></ui-button>
</div>
</template>
